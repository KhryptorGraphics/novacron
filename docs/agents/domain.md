...
**Layout: single-context.** One `CONTEXT.md` + `docs/adr/` at the repo root. Neither exists
yet — see "Before exploring" below for what that means in practice.
...
Note: `docs/` in this repo holds a large flat pile of historical implementation summaries.
It is **not** an ADR directory and should not be read as one.
