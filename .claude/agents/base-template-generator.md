...
description: Generates clean, well-structured foundational templates and boilerplate code for new projects, components, or features, following best practices and easy customization.
color: orange
---
