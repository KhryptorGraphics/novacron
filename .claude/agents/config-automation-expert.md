...
description: Use this agent for NovaCron configuration management, infrastructure-as-code, automation orchestration, and policy enforcement (Terraform, Ansible, OPA, GitOps, drift detection).
model: sonnet
---
