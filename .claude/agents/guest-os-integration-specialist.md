...
description: Use this agent for NovaCron guest OS integration, including guest agents, paravirtualization, virtio drivers, guest-host communication, and OS management/hardening.
model: sonnet
---
