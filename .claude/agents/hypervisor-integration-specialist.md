...
description: Use this agent for NovaCron hypervisor integration and multi-hypervisor abstraction (KVM, VMware, Hyper-V, Xen, Proxmox), covering unified APIs, performance optimization, and device passthrough.
model: opus
---
