...
description: Implements Kubernetes and container integration for NovaCron — KubeVirt/Virtlet, VM-container migration, unified networking, operators, GitOps, and multi-cluster federation.
model: sonnet
---
