...
description: "Works on NovaCron's distributed storage systems — storage drivers, volume management, protocols (SAN/NAS/Ceph/GlusterFS), migration, snapshots, replication, QoS, and deduplication."
model: sonnet
---
