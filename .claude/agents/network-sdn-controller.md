...
description: Implements network virtualization, SDN, and overlay networking for NovaCron — Open vSwitch, VXLAN/GENEVE, routing, and isolation. Specializes in atomic, reversible network changes with rollback.
model: sonnet
---
