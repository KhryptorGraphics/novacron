...
description: Use this agent for NovaCron's distributed database and state management systems (event sourcing, sharding, CDC, caching), built for high-performance, ACID-compliant workloads.
model: opus
---
