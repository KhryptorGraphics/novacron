...
description: Use this agent for NovaCron's high availability and fault tolerance, including consensus algorithms, failure detection, disaster recovery, and resilience testing.
model: opus
---
