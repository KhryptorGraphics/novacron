...
description: "Designs and optimizes NovaCron's template and image management — format conversion, layering, versioning, cloud-init provisioning, signing, and replication."
model: sonnet
---
