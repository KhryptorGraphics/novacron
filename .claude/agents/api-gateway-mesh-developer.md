...
description: Designs and optimizes API infrastructure — gateways, service meshes, GraphQL/gRPC, rate limiting, circuit breakers, and OAuth — for high-performance, low-latency systems.
model: sonnet
---
