...
description: "Designs, implements, and optimizes NovaCron's observability stack (metrics, tracing, dashboards, log aggregation, anomaly detection) using Prometheus, OpenTelemetry, and Grafana."
model: sonnet
---
