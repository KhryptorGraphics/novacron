...
description: Implements cloud provider integration, hybrid architecture, cost optimization, migration, and disaster recovery for NovaCron across AWS, Azure, GCP, and Oracle Cloud.
model: sonnet
---
